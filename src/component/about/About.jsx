  ...
  return (
    ...
    >
          ...
          <figure className="book">
            ...
            <ul className="page">
              ...
              <li className="flex justify-center items-center">
                <img src={coder2} alt="songoku" className="songoku" />
              </li>
              <li></li>
              <li></li>
            </ul>
        ...
        <div className="basis-1/2">
          <div className="flex">
            <div className="about-card">
              ...
              <p className="text-xs mt-2">1+ Year Working</p>
            </div>
            <div className="about-card">
              <BankOutlined style={{ fontSize: "24px", marginTop: "-12px" }} />
              <h3 className="mt-2 font-bold text-xl">Education</h3>
              <p className="text-xs mt-2">{"KMA (2017-2022)"}</p>
            </div>
          </div>
          <div className="mt-5">
            <h3 className="text-lg font-medium neon-text">Objective:</h3>
            <p className="neon-text">
              - Apply the experience, knowledge, and programming skills to
              become a professional programmer
            </p>
            <p className="neon-text">
              - Enhance ability to work and brings value to the company
            </p>
            <h3 className="text-lg font-medium neon-text mt-2">
              Education: Academy of Cryptograpy Tecniques (KMA)
            </h3>
            <p className="neon-text">- Major: Information Technology</p>
            <h3 className="text-lg font-medium neon-text mt-2">
              Experience: 1+ Year Working
            </h3>
            <p className="neon-text">
              (12/2021 - Present) - Fanxipan Technology Solution
            </p>
            <p className="neon-text">- Internship - Front-end Developer</p>
          </div>
        </div>
      </div>
      <div className="mt-10 flex gap-10">
        ...
        <svg
          viewBox="0 0 248 31"
          className="text-slate-900 dark:text-white w-auto h-5 mt-[6px]"
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
